...
//import { ArrowLeft,  ExternalLink,  Github,  Code2,  Star,  ChevronRight,  Layers,  Layout,  Globe,  Package,  Cpu,} from "lucide-react";
import {
  ArrowBack,
  Code,
  OpenInNew,
...
const TECH_ICONS = {
  ...
  VB: Code,
  Firebase: Storage,
  Angular: LanguageOutlined,
  XAML: Code,
  default: AllInboxOutlined,
};
  ...
  useEffect(() => {
    ...
    if (selectedProject) {
      const enhancedProject = {
        ...
        Github: selectedProject.Github || "https://github.com/Shakugantz",
      };
      ...
      <div className="relative">
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-16">
          <div className="flex items-center space-x-2 md:space-x-4 mb-8 md:mb-12 animate-fadeIn">
            ...
            >
              <ArrowBack className="w-4 h-4 md:w-5 md:h-5 group-hover:-translate-x-1 transition-transform" />
              <span>Back</span>
            </button>
            <div className="flex items-center space-x-1 md:space-x-2 text-sm md:text-base text-white/50">
              <span>Projects</span>
              <KeyboardArrowRight className="w-3 h-3 md:w-4 md:h-4" />
            ...
            <div className="space-y-6 md:space-y-10 animate-slideInLeft">
              ...
              <div className="flex flex-wrap gap-3 md:gap-4">
                ...
                >
                  ...
                  <OpenInNew className="relative w-4 h-4 md:w-5 md:h-5 group-hover:rotate-12 transition-transform" />
              ...
              <div className="space-y-4 md:space-y-6">
                <h3 className="text-lg md:text-xl font-semibold text-white/90 mt-[3rem] md:mt-0 flex items-center gap-2 md:gap-3">
                  <CodeOff className="w-4 h-4 md:w-5 md:h-5 text-blue-400" />
                  Technologies Used
                </h3>
            ...
            <div className="space-y-6 md:space-y-10 animate-slideInRight">
              ...
              <div className="bg-white/[0.02] backdrop-blur-xl rounded-2xl p-8 border border-white/10 space-y-6 hover:border-white/20 transition-colors duration-300 group">
                <h3 className="text-xl font-semibold text-white/90 flex items-center gap-3">
                  <StarOutline className="w-5 h-5 text-yellow-400 group-hover:rotate-[20deg] transition-transform duration-300" />
                  Key Features
                </h3>
