    ...
    <div className="flex items-start gap-3 ">
      {comment.profileImage ? (
        ...
        <div className="p-2 rounded-full bg-indigo-500/20 text-indigo-400 group-hover:bg-indigo-500/30 transition-colors">
          <AccountCircleOutlined className="w-5 h-5" />
        </div>
      )}
        ...
        <div className="flex items-center gap-4 p-4 bg-white/5 border border-white/10 rounded-xl">
          {imagePreview ? (
            ...
            <div className="w-full">
              ...
              >
                <AddPhotoAlternateOutlined className="w-5 h-5 group-hover:scale-110 transition-transform" />
      ...
      >
        <div className="flex items-center gap-3">
          <div className="p-2 rounded-xl bg-indigo-500/20">
            <ChatBubble className="w-6 h-6 text-indigo-400" />
          </div>
      ...
      <div className="p-6 space-y-6">
        {error && (
          <div
            ...
            data-aos="fade-in"
          >
            <ErrorOutlineOutlined className="w-5 h-5 flex-shrink-0" />
        ...
        >
          {comments.length === 0 ? (
            <div className="text-center py-8" data-aos="fade-in">
              <AccountCircleOutlined className="w-12 h-12 text-indigo-400 mx-auto mb-3 opacity-50" />
