...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: LinkedIn,
    url: "https://www.linkedin.com/in/carlosjordanc/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@Kalin.JC",
    icon: Instagram,
    url: "https://www.instagram.com/kalin.jc/?next=%2F",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@Kazumadex",
    icon: YouTube,
    url: "https://www.youtube.com/@Kazumadex",
    color: "#FF0000",
  ...
  },
  {
    ...
    subText: "@Shakugantz",
    icon: GitHub,
    url: "https://github.com/Shakugantz",
    color: "#ffffff",
  ...
  }*/
  {
    ...
    subText: "@KalinJC",
    icon: Facebook,
    url: "https://www.facebook.com/kalin.jordancastro",
    color: "#1E3A8A",
    gradient: "from-[#1E3A8A] to-[#4F6B96]",
  },
];
