        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex-shrink-0">
            <a
              ...
              className="text-xl font-bold bg-gradient-to-r from-[#a855f7] to-[#6366f1] bg-clip-text 
                                   text-transparent transition-all duration-500 ease-in-out hover:filter hover:brightness-150"
            >
              Kalin
            </a>
          </div>
