...
import { Code, WorkspacePremium, Widgets } from "@mui/icons-material";
...
const techStacks = [
  ...
  { icon: "sql.svg", language: "SQL Server" },
  ...
  { icon: "vb6.svg", language: "Visual Basic 6.0" },
  { icon: "vite.svg", language: "Vite" },
  { icon: "bootstrap.svg", language: "Bootstrap" },
  { icon: "firebase.svg", language: "Firebase" },
  { icon: "MUI.svg", language: "Material UI" },
  { icon: "vercel.svg", language: "Vercel" },
  { icon: "netcore.svg", language: "Net Core" },
...
export default function FullWidthTabs() {
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      setCertificates(CertificatesImg);
    } catch (error) {
    ...
    >
      ...
      >
        ...
        <p className="text-slate-400 max-w-2xl mx-auto text-sm md:text-base mt-2">
          Embark on a journey through my projects, certifications, and technical
          expertise; each step a reflection of my commitment to growth,
      ...
      <Box sx={{ width: "100%" }}>
        ...
        >
          ...
          >
            ...
            <Tab
              icon={
                <WorkspacePremium className="mb-2 w-5 h-5 transition-all duration-300" />
              }
              label="Certificates"
              {...a11yProps(1)}
            />
            <Tab
              icon={
                <Widgets className="mb-2 w-5 h-5 transition-all duration-300" />
              }
              label="Tech Stack"
              {...a11yProps(2)}
            />
        ...
        <Swiper
          ...
          onSwiper={(swiper) => setValue(swiper.activeIndex)}
          initialSlide={value}
        >
