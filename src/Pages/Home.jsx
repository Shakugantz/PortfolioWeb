...
const WORDS = ["System Engineer", "Tech Lider", "Full Stack"];
const TECH_STACK = [
  "AWS",
  "Unity",
  "ReactJS",
...
const SOCIAL_LINKS = [
  { icon: GitHub, link: "https://github.com/Shakugantz/" },
  { icon: LinkedIn, link: "https://www.linkedin.com/in/carlosjordanc/" },
  { icon: Instagram, link: "https://www.instagram.com/kalin.jc/" },
  { icon: Facebook, link: "https://www.facebook.com/kalin.jordancastro/" },
];
...
const Home = () => {
  ...
  const lottieOptions = {
    src: "https://lottie.host/e9e6d83b-3d2a-4dc1-9a31-d2ad205690cd/qRxYbGx4HQ.lottie",
    loop: true,
    autoplay: true,
  ...
  return (
    <div className="min-h-screen bg-[#030014] overflow-hidden pt-16" id="Home">
      <div
            ...
            >
              <div className="space-y-4 sm:space-y-6">
                ...
                <p
                  ...
                  data-aos-delay="1000"
                >
                  Developer with over 10 years of experience in banking,
                  logistics, and business systems.
                  <br />
                  Development of apps, websites, landing pages, APIs, desktop
                  applications and ERPs.
                </p>
