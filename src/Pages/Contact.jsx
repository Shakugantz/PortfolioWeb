        ...
        <div className="container px-[1%] grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-[45%_55%] 2xl:grid-cols-[35%_65%] gap-12">
          ...
          >
            <div className="flex justify-between items-start mb-8">
              ...
              <Share className="w-10 h-10 text-[#6366f1] opacity-50" />
            </div>

            <form
              action="https://formsubmit.co/carlosjordanc91@gmail.com"
              method="POST"
            ...
            >
              ...
              >
                <PersonOutlineOutlined className="absolute left-4 top-4 w-5 h-5 text-gray-400 group-focus-within:text-[#6366f1] transition-colors" />
                <input
                  type="text"
                  name="name"
              ...
              <div
                ...
                className="relative group"
              >
                <ChatBubbleOutline className="absolute left-4 top-4 w-5 h-5 text-gray-400 group-focus-within:text-[#6366f1] transition-colors" />
                <textarea
                  name="message"
